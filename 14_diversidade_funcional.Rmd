...
Vamos calcular primeiramente as matrizes de Dispersão funcional (FDis) e Regularidade Funcional (FEve), depois ajustar modelos lineares, fazer o diagnóstico dos mesmo e por fim plotar os resultados (Figura \@ref(fig:fig-func-comp-model)).
...
## Passo 2: calcular a Dispersão funcional (FDis) e Regularidade Funcional (FEve)
...
ggplot(pcoa_dat, aes(x = Axis.1, y = Axis.2, color = pastagem, shape = pastagem)) + 
  ...
  labs(x = "PCoA 1 (53.6%)", y = "PCoA 2 (24.6%)") + 
  tema_livro()
